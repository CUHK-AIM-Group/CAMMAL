...
root = '~code/PLM/taming-transformers/logs/2023-06-27T20-20-29_custom_vqgan/'
# yaml_file = os.path.join(root, '2023-05-11T23-37-27-project.yaml')
# model_path = os.path.join(root, 'last-3e.ckpt')
PATH_CONFIG = os.path.join(root, 'configs/2023-06-27T20-20-29-project.yaml') #'2023-05-11T23-37-27-project.yaml') #"<path to the trained model config (.yaml)>"
PATH_CKPT = os.path.join(root, 'checkpoints/last.ckpt') #'last-3e.ckpt') #"<path to the trained model ckpts (.ckpt)>"
RESIZE_SIZE = 256
...
save_root = "~dataset/x_ray/openI_data/data/openI_vqgan1024_codebook_"  + str(split_id) + "_" + str(split_num) + ".pickle"
