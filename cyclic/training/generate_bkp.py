...
from .consts import END_KEY, PROMPT_FOR_GENERATION_FORMAT, PROMPT_FOR_GENERATION_FORMAT_NOINPUT, RESPONSE_KEY, PROMPT_WITH_KEYWORDS_FOR_GENERATION_FORMAT
...
class InstructionTextGenerationPipeline(Pipeline):
    ...
    def preprocess(self, instruction_text, **generate_kwargs):
        ...
        if input_len == 2:
            ...
            instruction_text, input_text, keywords = instruction_text
        ...
        if input_text is None:
            ...
            if input_len == 2:
                ...
                prompt_text = PROMPT_WITH_KEYWORDS_FOR_GENERATION_FORMAT.format(instruction=instruction_text, input=CXR_VQ_VQ_REPLACE_TEMPLATE, keyword=keywords)
