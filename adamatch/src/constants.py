...
# #############################################
MIMIC_CXR_TEXT_DIR = Path("path_to_mimic_xray/mimic-cxr-reports")
MIMIC_CXR_IMAGE_DIR = Path("path_to_mimic_xray/images/all_data")

MIMIC_CXR_DATA_DIR = Path("../materials/anno")# _new #DATA_BASE_DIR / "raw/physionet.org/files/mimic-cxr-jpg/2.0.0"
...
# OpenI constants
# #############################################
OPENI_MASTER_CSV = Path("./dataset/x_ray/openI/anno/openIdf.csv")
OPENI_DATA_DIR = Path("./dataset/x_ray/openI/anno")
OPENI_SPLIT_COL = "split"
OPENI_IMAGE_DIR = Path("./dataset/x_ray/openI/Img")
# #############################################
# RSNA constants
# #############################################
