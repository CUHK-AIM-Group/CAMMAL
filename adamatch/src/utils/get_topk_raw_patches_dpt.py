...
threshold = 0.6
img_root = "path_to_all_images/mimic_xray/images/all_data"
vq_path = "../../materials/anno/mimiccxr_vqgan1024_res256_3e_codebook_indices.pickle"
filepath = "./adamatch/data/topk_patch_list/pickles/2023_09_21_19_00_21.pickle"
...
save_path = os.path.join("./adamatch/data/topk_patch_list", "top"+str(sim_topk)+"_"+which_date+"_patches_list.pickle")
